...
<script type="text/javascript">
	$(function(){
		$("#username").change(function(){
			...
			$.get("api/v1/checkname.do","uname="+this.value,function(data){
				if(data.code==1){
	...
	<div class="regist">
		<div class="regist_center">
			...
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" action="/api/v1/register.do" method="get">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span  class="help-block ">请输入6位以上字符</span></p>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="width: 40%">
							<input type="text" name="umail" class="form-control col-sm-10"
								placeholder="Email" />
						</div>
						<div class="col-sm-2">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						<p class="text-danger"><span  class="help-block ">你是帅哥 还是美女</span></p>
						</div>
					</div>
					<hr>
					<div class="form-group">
